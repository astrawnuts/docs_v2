...
function getCurrentFinancialYear(day, month, year) {
    ...
    current_financial_period_start = current_financial_period_start + "/" + current_year_start;  
    current_financial_period_end = current_financial_period_end + "/" + current_year_end; 

    //creates a financial period string
    current_financial_period_string = current_financial_period_start + " to " + current_financial_period_end;
    return current_financial_period_string;

}

function getLastFinancialYear(day, month, year) {
...
last_year_financial_period_string = last_year_financial_period_start + " to " + last_year_financial_period_end;
...
// document.addEventListener('DOMContentLoaded', updateText, false);
    ...
    return (
        <>
            <span>Previous Financial Year: {getLastFinancialYear(null, null, null)}</span>
        </>
    )
}
